...
help = "-h"
print("")
print(P+"[+] Type -h to help")
print("[+] Type -c to continue")
print("[+] Type -m to mood menue")
...
while True:
    ...
    help1 = input("[-] Inter Your choices: ")
    contin = "-c"
    mood = "-m"
    exi = "-E"
    ...
    if help == help1:
        print("Usage: hashcat [options]... hash|hashfile|hccapxfile [dictionary|mask|directory]...")
  ...
  10000 | Django (PBKDF2-SHA256)                           | Framework
    124 | Django (SHA-1)                                   | Framework
        ...
        colour = random.choice(rand)
        colour1 = random.choice(rand)
        print(colour)
        os.system("clear")
        print("[+]===============================================================================")
        print("[+]                                                                               |")
        print("[+]                                                                               |")
        print(f"[+]                             Please press {colour1}-E {colour}                                  |")
        print("[+]                                  👿️👿️👿️                                       |")
        print("[+]                                                                               |")
        print("[+]                                                                               |")
        print("[+]===============================================================================")
...
os.system("clear")
print(colour+f"   ===============================================================================")
print(f"  |[{colour1}+{colour}] Name : {B}SHOUNTO{colour}                                                             ||")
print(f"  |[{colour1}+{colour}] Facebook : TOUAJHASANSHOUNTO                                               ||")
print(f"  |[{colour1}+{colour}] Number : 01880466827                                                       ||")
print(f"  |[{colour1}+{colour}]                                                                            ||")
print(f"  |[{colour1}+{colour}]                                                                            ||")
print(f"  |[{colour1}+{colour}]                                                                            ||")
print(colour+f"   ===============================================================================")
...
#===================================================================================================================B
c = input(f"[{B}+{colour}]Inter Your catagory:{R} ")
m = input(f"[{B}+{colour}]Inter Your mode:{R} ")
f = input(f"[{B}+{colour}]Inter Your file hash name:{R} ")
w = input(f"[{B}+{colour}]Inter Your hash file name:{R} ")
print(C+"")

os.system(f"hashcat -a {c} -m {m} {f} {w}")
